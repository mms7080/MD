...
const sampleProjects = [
  { id:"p1", title:"Pawple", creator:"J. Kim",
    ...
    desc:"반려동물 건강관리 및 펫 스토어", link:"/portfolios/1" },
  { id:"p2", title:"NotePad", creator:"M. Lee",
    tags:["NodeJs","React","JavaScript","HTML","CSS","Tailwind"], likes:203,
    createdAt:"2025-06-01", cover:"https://kafolio.kr/static/requests/2024/9/5/boards/OGRiMjA2YmEyYWMxY2VmOGMxNDJkNjI2ZGM0YTZmMjVlN2VlNzdjYjZlOGE1ZDQzYWI3YTJiNzIxMzgwZjMzOQ==.jpg",
    desc:"강의 자료 및 메모장", link:"/portfolios/2" },
  { id:"p3", title:"OSPE", creator:"A. Park",
    tags:["Java","Thymeleaf","JavaScript","SQL","HTML","XML","JSON"], likes:96,
    createdAt:"2025-07-10", cover:"https://kafolio.kr/static/requests/2024/12/30/boards/MGFiYzI1YmM1MzBlYmM2M2FjYzFkYzgxZmIyNWVkMzBkN2Q0MWEzODVmYzM0OTZlNzY4MjA0NjFiYTk2MDljOA==.png",
    desc:"진료 예약 및 처방전 출력", link:"/portfolios/3" },
  { id:"p4", title:"Planner for U", creator:"D. Choi",
    tags:["Java","SCSS","JavaScript","HTML","Typescript","Thymeleaf"], likes:310,
    createdAt:"2025-05-20", cover:"https://kafolio.kr/static/requests/2024/9/4/boards/NjRlNGMwMzJkZDc0OTJlYzZjYTdiYTk3ZTE5YjEyOTEyZmYwODhhZDE4NmM5MjExZDNkYzgzZmE4ZThmZjhkOA==.png",
    desc:"공유 캘린더 기능", link:"/portfolios/4" },
  { id:"p5", title:"Filmora", creator:"S. Han",
    ...
    desc:"영화 예매 및 스토어 이벤트.", link:"/portfolios/5" },
  { id:"p6", title:"Pickup", creator:"B. Yoo",
    tags:["JavaScript","React","Express"], likes:65,
    createdAt:"2025-02-18", cover:"https://kafolio.kr/static/requests/2024/4/26/boards/MTkyMzEwZTdiOTM2Mjk0NjQ3NDdhMjBiNGQ4OGEwNjdmYWI3YzlkMDk1MGQ5ODg5ZmIyMTBiNzg4NTBjOGIxZA==.jpg",
    desc:"리그오브레전드 아이템 계산기", link:"/portfolios/6" },
  { id:"p7", title:"취미존중", creator:"H. Jung",
    tags:["Java","TypeScript","JavaScript","HTML","CSS","SCSS","Thymeleaf"], likes:181,
    createdAt:"2025-04-02", cover:"https://kafolio.kr/static/requests/2024/9/5/boards/NmQ4OTU1OGMwZTQ4ODcyZTFmMTExY2M3ZTEwOTA4ZjBlNzAxMDBlMTJkZGEyZDg5MDBmMjM3NzA4ZmY2ZDYxMw==.png",
    desc:"원데이 클래스 예약 사이트", link:"/portfolios/7" },
  { id:"p8", title:"O_O 커뮤니티", creator:"R. Kwon",
    tags:["React","HTML","CSS","JavaScript"], likes:142,
    createdAt:"2025-03-12", cover:"https://kafolio.kr/static/requests/2024/5/3/boards/MjFhOWE5YzMxZmYxMjFmN2E0MzBlZDk1NmRmMDU2MGE5Y2ZkYzZkMmI1ZDIyMzBlNzRhYWE5Nzc5NzE0ODY1Yw==.png",
    desc:"커뮤니티 사이트", link:"/portfolios/8" },
  { id:"p9", title:"ModeMe", creator:"Y. Song",
    ...
    desc:"20대 남성 전문 쇼핑몰" ,link:"portfolios/9"},
];
...
function createCard(project){
  ...
  el.innerHTML = `
    ...
    <div class="card-actions">
      ...
      <a class="btn ghost" href="${project.link}" rel="noopener">원본</a>
